...
/*   const routes = [
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      router.push(
        `/teacher/classes/${classId}/courses/${course.id}/sections/${response.data.id}`
      );
...
{/*       <div className="flex gap-5">
      ...
      <SectionList
        ...
        onReorder={onReorder}
        onEdit={(id) =>
          router.push(`/teacher/classes/${classId}/courses/${course.id}/sections/${id}`)
        }
      />

      <h1 className="text-xl font-bold mt-5">Add New Content</h1>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 mt-5">
          ...
          <div className="flex gap-5">
            <Link href={`/teacher/classes/${classId}/courses/${course.id}/basic`}>
