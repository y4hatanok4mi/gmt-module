    ...
    cell: ({ row }) => {
      ...
      const handleDelete = async (id: number) => {
        try {
          ...
          console.log(result.message); // Successful deletion
        } catch (error: unknown) {
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex justify-end pt-2">
        <Button onClick={handleExport} className="px-4 py-2 gap-1 bg-green-600 text-white rounded">
            <BookAIcon/> Export to PDF
        </Button>
      </div>
    </div>
  )
